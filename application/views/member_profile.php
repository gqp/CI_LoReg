...
<div id="container">
    ...
    <a href='<?php echo site_url('members'); ?>'>Back to Members Area</a> |  <a href='<?php echo site_url('member_profile/change_password'); ?>'>Change Password</a> | <a href='<?php echo site_url('member_profile/edit'); ?>'>Edit Profile</a> | <a href='<?php echo site_url('login/logout'); ?>'>Logout</a>
</div>
